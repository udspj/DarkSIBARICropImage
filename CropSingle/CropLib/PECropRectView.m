    ...
    for (NSInteger i = 0; i < 3; i++) {
        ...
        if (self.showsGridMinor) {
            for (NSInteger j = 1; j < 4; j++) {
                ...
                UIRectFill(CGRectMake(roundf(width / 3 / minorLineNum * j + width / minorLineNum * i), borderPadding, 1.0f, roundf(height) - borderPadding * (minorLineNum - 1)));
                UIRectFill(CGRectMake(borderPadding, roundf(height / 3 / minorLineNum * j + height / minorLineNum * i), roundf(width) - borderPadding * (minorLineNum - 1), 1.0f));
            }
        }
